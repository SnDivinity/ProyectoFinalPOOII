...
public class ServicioController {
    ...
    public ServicioController(ServicioRepositorio servicioRepo, ConsumoRepositorio consumoRepo, BuscadorServicios buscadorServicios) {
        this.servicioRepo = this.servicioRepo;
        this.consumoRepo = this.consumoRepo;
